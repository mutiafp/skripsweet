      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="<?=base_url('admin/kesmas')?>">Kesehatan Masyarakat</a></li>
            <li><a href="<?=base_url('admin/chart1')?>">Grafik Jumlah Penduduk</a></li>
            <li><a href="<?=base_url('admin/chart2')?>">Grafik Rumah Sehat</a></li>
            <li><a href="<?=base_url('admin/chart3')?>">Grafik Penyebaran Penyakit</a></li>
            <li><a href="<?=base_url('admin/daftarpengguna')?>">Daftar Pengguna</a></li>
